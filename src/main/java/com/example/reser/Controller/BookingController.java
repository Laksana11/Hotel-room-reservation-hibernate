...
import com.example.reser.HelloApplication;
...
public class BookingController implements Initializable {
    ...
    @FXML
    private Label acStatus,total_amount, total_day,Price,in, out, roomAvailability, roomNum, type;

    @FXML
    private GridPane grid;
    @FXML
    private Label nameLbl2, testing;
    @FXML
